...
static TypedField<rpg::SaveMapEvent, uint32_t> static_easyrpg_clone_event_id(
	&rpg::SaveMapEvent::easyrpg_clone_event_id,
	LSD_Reader::ChunkSaveMapEvent::easyrpg_clone_event_id,
	"easyrpg_clone_event_id",
	0,
	0
);
static TypedField<rpg::SaveMapEvent, rpg::SaveMapEvent::EasyRpgRuntime_Flags> static_easyrpg_runtime_flags(
