...
namespace rpg {
	...
	inline bool operator==(const SaveEventExecState::EasyRpgRuntime_Flags& l, const SaveEventExecState::EasyRpgRuntime_Flags& r) {
	...
	std::ostream& operator<<(std::ostream& os, const SaveEventExecState::EasyRpgRuntime_Flags& obj);
