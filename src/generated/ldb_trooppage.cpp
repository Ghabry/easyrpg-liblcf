...
static SizeField<rpg::TroopPage, DBArray<rpg::EventCommand>> static_size_event_commands(
	&rpg::TroopPage::event_commands,
	LDB_Reader::ChunkTroopPage::event_commands_size,
	1,
	0
);
static TypedField<rpg::TroopPage, DBArray<rpg::EventCommand>> static_event_commands(
	&rpg::TroopPage::event_commands,
